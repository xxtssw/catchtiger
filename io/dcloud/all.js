...
!function(a) {
    ...
    var T = plus.tools, B = plus.bridge = {
        ...
        exec:function(a, b, c, d) {
            if (c.push(d), T.IOS == T.platform) {
                if (window.webkit && window.webkit.messageHandlers) return window.webkit.messageHandlers.plus.postMessage("[" + T.stringify([ window.__HtMl_Id__, a, b, d || null, c ]) + "]"), 
                void 0;
                B.commandQueue.push(T.stringify([ window.__HtMl_Id__, a, b, d || null, c ])), B.execIframe && !B.execIframe.parentNode && document.body.appendChild(B.execIframe), 
                1 != B.commandQueue.length || B.isInEvalJs || (B.execIframe = B.execIframe || createExecIframe(), 
                B.execIframe.src = "plus://command");
            } else T.ANDROID == T.platform && window.prompt(T.stringify(c), "pdr:" + T.stringify([ a, b, !0 ]));
        },
        execSync2:function(a, b, c, d) {
            var e, f;
            try {
                if (T.IOS == T.platform && "function" == typeof __dc__plusGo) return e = T.stringify([ [ window.__HtMl_Id__, a, b, null, c ] ]), 
                f = __dc__plusGo(e), d ? d(f) :window.eval(f);
            } catch (g) {
                console.log("sf:" + b + "-" + a);
            }
            return B.execSync(a, b, c, d);
        },
        ...
        nativeEval:function(a) {
            if (T.IOS == T.platform) {
                if (window.webkit && window.webkit.messageHandlers) return window.setTimeout(a, 0), 
                "";
                B.isInEvalJs++;
                try {
        ...
        createPlayer:function(a) {
            var e = {
                ...
                getDuration:function() {
                    return b.execSync2(d, g, [ "getDuration", [ this._Audio_Player_UUID_ ] ]);
                },
                getPosition:function() {
                    return b.execSync2(d, g, [ "getPosition", [ this._Audio_Player_UUID_ ] ]);
                },
                setRoute:function(a) {
    ...
    function d(a, d, e) {
        var g, h, i, f = this;
        f.onmarked = null, f.onerror = null, f.isClose = !1, g = c.callbackId(function(a) {
            "function" == typeof f.onmarked && f.onmarked(a.type, a.message, a.file);
        }, function(a) {
            "function" == typeof f.onerror && f.onerror(a);
        }), h = document.getElementById(a), h.addEventListener("resize", function() {
            var a = [ h.offsetLeft, h.offsetTop, h.offsetWidth, h.offsetHeight ];
            c.exec(b, "resize", [ a ]);
        }, !1), i = [ h.offsetLeft, h.offsetTop, h.offsetWidth, h.offsetHeight ], c.exec(b, "Barcode", [ g, i, d, e ]);
    }
    var f, b = "barcode", c = window.plus.bridge, e = d.prototype;
    e.start = function(a) {
        this.isClose || c.exec(b, "start", [ a ]);
    }, e.setFlash = function(a) {
        this.isClose || c.exec(b, "setFlash", [ a ]);
    }, e.cancel = function() {
        this.isClose || c.exec(b, "cancel", []);
    }, e.close = function() {
        this.isClose || (c.exec(b, "close", []), this.isClose = !0);
    }, f = {
        Barcode:d,
    ...
    f.captureImage = function(a, d, e) {
        ...
        getCamera:function(a) {
            ...
            d.supportedImageResolutions = [ "640*480", "1280*720", "960*540" ], d.supportedVideoFormats = [ "mp4" ], 
            d.supportedVideoResolutions = [ "640*480", "1280*720", "960*540" ]), d;
        }
    }, a.camera = g;
...
plus.console.time = function() {}, plus.console.timeEnd = function() {}), function(a) {
    ...
    e.BUSY = 1, f = a.gallery = {
        ...
        pick:function(a, g, h) {
            var i, j;
            return d.Busy == f.__galleryStatus ? (window.setTimeout(function() {
                "function" == typeof g && g(new e(e.BUSY, "已经打开了相册"));
            }, 0), void 0) :(f.__galleryStatus = d.Busy, i = b.callbackId(function(b) {
            ...
            }), j = b.callbackId(function() {
                "function" == typeof h.onmaxed && h.onmaxed();
            }), b.exec(c, "pick", [ i, h, j ], {
                cbid:i
            }), void 0);
        },
    ...
    function j(a, b) {
        var c = setTimeout(function() {
            k(c), c = null, a(new h(h.TIMEOUT, "Position retrieval timed out."));
        }, b);
        return c;
    }
    function k(a) {
    ...
    function m(a, d, e, f) {
        ...
        return e = i(e), m = {
            ...
            if (k(m.timer), m.timer) {
                ...
                l.lastPosition = c, a(c);
            }
        }, o = function(a) {
            k(m.timer), m.timer = null;
            var b = new h(a.code, a.message);
            d && d(b);
        }, l.lastPosition && e.maximumAge && new Date().getTime() - l.lastPosition.timestamp <= e.maximumAge ? a(l.lastPosition) :0 === e.timeout ? o(new h(h.TIMEOUT, "timeout value in PositionOptions set to 0 and no cached Position object available, or cached Position object's age exceeds provided PositionOptions' maximumAge parameter.")) :(m.timer = 1 / 0 !== e.timeout ? j(o, e.timeout) :!0, 
        f && (p = c.callbackId(n, o), c.exec(b, "getCurrentPosition", [ p, e.enableHighAccuracy, e.maximumAge, e.coordsType, e.provider, e.geocode, e.timeout ]))), 
        m;
    }
    var b = "Geolocation", c = window.plus.bridge, d = window.plus.tools, e = {}, l = a.geolocation = {
        lastPosition:null,
        getCurrentPosition:function(a, b, c) {
            m(a, b, c, !0);
        },
        watchPosition:function(a, f, n) {
            var o, p, q, r;
            return n = i(n), o = d.UUID("timer"), e[o] = m(a, f, n, !1), p = function(a) {
                k(e[o].timer);
                var b = new h(a.code, a.message);
                f && f(b);
            }, q = function(b) {
                k(e[o].timer), 1 / 0 !== n.timeout && (e[o].timer = j(p, n.timeout));
                var c = new g({
                    latitude:b.latitude,
                    longitude:b.longitude,
                    altitude:b.altitude,
                ...
                l.lastPosition = c, a(c);
            }, r = c.callbackId(q, p), c.exec(b, "watchPosition", [ r, o, n.enableHighAccuracy, n.coordsType, n.provider, n.geocode ]), 
            o;
        },
        clearWatch:function(a) {
            a && void 0 !== e[a] && (k(e[a].timer), e[a].timer = !1, c.exec(b, "clearWatch", [ a ]));
        }
    };
}(window.plus), function(a) {
    function f(a) {
    ...
    function n(a) {
        ...
        a && "string" == typeof a.position && (b.position = a.position), b;
    }
    function o(b, d) {
        function f(a, b) {
    ...
    p.centerAndZoom = function(a, b) {
        ...
        var b, a = document.getElementById(this._ui_div_id_);
        a && (b = [ a.offsetLeft, a.offsetTop, a.offsetWidth, a.offsetHeight ], k(this._UUID_, "resize", b));
    }, p.getZoom = function() {
        return this.zoom;
        ...
        this.__contentImage = a, this.__contentImageAsDataURL = null, this.marker && k(this.marker._UUID_, "loadImage", [ a ]);
    }, r.loadImageDataURL = function(a) {
        this.__contentImage = null, this.__contentImageAsDataURL = a, this.marker && k(this.marker._UUID_, "loadImageDataURL", [ a ]);
    }, r.getLabel = function() {
        return this.label;
    ...
    a.storage = {
        getLength:function() {
            return b.execSync2(c, "getLength", [ null ]);
        },
        getItem:function(a) {
            return "string" == typeof a ? b.execSync2(c, "getItem", [ a ], function(a) {
                var b = a.indexOf(":"), c = a.substr(0, b);
                return "null" === c ? null :a.substr(b + 1);
            }) :!1;
        },
        setItem:function(a, d) {
            return "string" == typeof a && "string" == typeof d ? b.execSync2(c, "setItem", [ a, d ]) :!1;
        },
        removeItem:function(a) {
            return "string" == typeof a ? b.execSync2(c, "removeItem", [ a ]) :!1;
        },
        clear:function() {
            return b.execSync2(c, "clear", [ null ]);
        },
        key:function(a) {
            return "number" == typeof a ? b.execSync2(c, "key", [ a ]) :!1;
        }
    };
}(window.plus), function(a) {
    function e(a, b, c) {
    ...
    function f(a, b, c) {
        this.__UUID__ = d.UUID(), this.url = d.getValue(a, ""), this.options = b || {}, 
    ...
    }, g.overrideMimeType = function(a) {
        b.exec(f.__F__, "overrideMimeType", [ this.__UUID__, a ]);
    }, g.send = function(a) {
        var d, c = this;
    ...
    d.process = function(a) {
        ...
        if (a = l(a), a.__TYPE__) {
            ...
            d = a.__UUID__, c = a, a = a.className;
        }
        if (f = e.isImport(a)) return f;
        if (g = b.execSync(_Server, "__inheritList", [ a, d ])) {
            for (h = g.length, i = h - 1; i >= 0; i--) f = i == h - 1 ? e.importClass(g[i], null) :e.importClass(g[i], g[i + 1]);
            return c && (c.__proto__ = f.prototype), f;
        }
        return null;
    ...
    a.navigator = {
        ...
        updateSplashscreen:function(a) {
            b.exec(d, "updateSplashscreen", [ a ]);
        },
        ...
        createShortcut:function(a, c, e) {
            var f = b.callbackId(c, e);
            b.exec(d, "createShortcut", [ a, f ]);
        },
        ...
        checkPermission:function(a) {
            return b.execSync(d, "checkPermission", [ a ]);
        }
    };
}(window.plus), function(a) {
    ...
    function o() {
        ...
        var a = b.execSync(c, e, [ c, "defaultHardwareAccelerated", [] ]);
        return a;
    }
    function p(e, g, h) {
    ...
    function r() {
        ...
        return (null == g || void 0 === g) && (h = b.execSync2(c, e, [ c, "currentWebview", [ window.__HtMl_Id__ ] ]), 
    ...
    function s() {
        var h, g = b.execSync2(c, e, [ c, "getLaunchWebview", [] ]);
    ...
    function A() {
        var g, i;
        return h.IOS == h.platform ? null :(g = b.execSync(c, e, [ c, "getWapLaunchWebview", [] ]), 
        g ? (i = f[g.uuid], null == i && (i = new a.webview.Webview(null, null, !0, g.extras), 
        i.__uuid__ = g.uuid, i.id = g.id, b.exec(c, d, [ c, "setcallbackid", [ i.__uuid__, [ i.__callback_id__ ] ] ]), 
        f[i.__uuid__] = i), i) :null);
    }
    function B() {
        var h, g = b.execSync(c, e, [ c, "getTopWebview", [ window.__HtMl_Id__ ] ]);
        return g ? (h = f[g.uuid], null == h && (h = new a.webview.Webview(null, null, !0, g.extras), 
        h.__uuid__ = g.uuid, h.id = g.id, b.exec(c, d, [ c, "setcallbackid", [ h.__uuid__, [ h.__callback_id__ ] ] ]), 
    ...
    a.webview = {
        ...
        defaultHardwareAccelerated:o,
        exec:u,
        execSync:v,
        _find__Window_By_UUID__:p,
        __pushWindow__:i,
        __popWindow__:j,
    ...
    function c(c, d) {
        ...
        a.webview.__pushWindow__(h), this.__children.push(h), i = [ h.__uuid__, [ g.url, g.styles, h.__callback_id__, location.host + location.pathname, g.extras ] ], 
        e.push(i);
    ...
    function i(c, d, e, f) {
        ...
        !this.id && c && (this.id = d.name = c), e || (a.__pushWindow__(this), a.exec(this, b, [ c, d, this.__callback_id__, h(), f ]));
    }
    var b = "NWindow", c = "UI", e = "execMethod", f = plus.bridge, g = plus.tools, j = i.prototype;
    plus.tools.extend(j, a.NView.prototype), j.constructor = i, j.show = function(b, c, d, e) {
        var g;
        d && "function" == typeof d && (g = f.callbackId(function() {
            d();
        })), a.exec(this, "show", [ b, c, null, g, e ]);
    }, j.close = function(b, c, d) {
        ...
        if ("string" == typeof c) d = c; else {
            if (!(c instanceof plus.webview.Webview)) return c instanceof plus.nativeObj.View ? (a.exec(this, "removeNativeView", [ b, c.__uuid__ ]), 
            void 0) :void 0;
            d = c.__uuid__;
        }
        a.exec(this, "remove", [ d ]);
    }, j.removeFromParent = function() {
        ...
        return a.execSync(this, "getOption");
    }, j.loadURL = function(b) {
        b && "string" == typeof b && a.exec(this, "load", [ b, h() ]);
    }, j.loadData = function(b, c, d) {
        b && "string" == typeof b && a.exec(this, "loadData", [ b, h(), c, d ]);
    }, j.stop = function() {
        a.exec(this, "stop", []);
    }, j.reload = function(b) {
        a.exec(this, "reload", [ b ]);
    }, j.draw = function(b, c, d) {
        var e, h;
        ...
        c && (c instanceof plus.webview.Webview || c instanceof plus.webview.WebviewGroup ? (this.__view_array__.push(c), 
        a.exec(this, "append", [ c.__IDENTITY__, c.__uuid__ ])) :c instanceof plus.nativeObj.View && a.exec(this, "appendNativeView", [ b, c.__uuid__ ]));
    }, j.setPullToRefresh = function(b, c) {
        var d;
        c && (d = plus.bridge.callbackId(c)), this.addEventListener("pulldownrefreshevent", c, !1), 
        a.exec(this, "setPullToRefresh", [ b, d ]);
    }, j.endPullToRefresh = function() {
        a.exec(this, "endPullToRefresh", []);
    }, j.setBounce = function(b, c) {
        a.exec(this, "setBounce", [ b, c ]);
    }, j.resetBounce = function() {
        a.exec(this, "resetBounce", []);
    }, j.setBlockNetworkImage = function(b) {
        a.exec(this, "setBlockNetworkImage", [ b ]);
    }, j.captureSnapshot = function(b, c, d) {
    ...
    }, j.clearSnapshot = function(b) {
        plus.tools.platform != plus.tools.IOS && a.exec(this, "clearSnapshot", [ b ]);
    }, j.overrideUrlLoading = function(b, c) {
        var d = f.callbackId(function(a) {
            "function" == typeof c && c(a);
        });
        a.exec(this, "overrideUrlLoading", [ b, d ]);
    }, j.overrideResourceRequest = function(b) {
        a.exec(this, "overrideResourceRequest", [ b ]);
    }, j.isHardwareAccelerated = function() {
        return g.platform == g.IOS ? !1 :a.execSync(this, "isHardwareAccelerated", []);
    }, j.listenResourceLoading = function(b, c) {
        var d = f.callbackId(function(a) {
            "function" == typeof c && c(a);
        });
        a.exec(this, "listenResourceLoading", [ b, d ]);
    }, a.Webview = i;
}(window.plus.webview), function(a) {
    function d() {
    ...
    function g(a, e) {
        this.__id__ = d.UUID("Bitmap"), this.id = a, e || (f[this.__id__] = this, c.exec(b, "Bitmap", [ this.__id__, a ]));
    }
    function h(a, f, g) {
        this.__id__ = a, this.__uuid__ = d.UUID("NativeView"), g || (c.exec(b, "View", [ this.__id__, this.__uuid__, f ]), 
        e[this.__id__] = this);
    }
    var i, b = "NativeObj", c = a.bridge, d = a.tools, e = {}, f = {};
    g.prototype.clear = function() {
        c.exec(b, "clear", [ this.__id__ ]), this.__id__ = void 0, f[this.__id__] && delete f[this.__id__];
    }, g.prototype.load = function(a, d, e) {
        var g, f = function(a) {
            "function" == typeof e && e(a);
        };
    ...
    }, g.prototype.loadBase64Data = function(a, d, e) {
        var g, f = function(a) {
            "function" == typeof e && e(a);
        };
        this.__id__ ? (g = c.callbackId(function() {
    ...
    }, g.prototype.save = function(a, d, e, f) {
        var h, g = function(a) {
            "function" == typeof f && f(a);
        };
    ...
    }, g.prototype.__captureWebview = function(a, d, e) {
        var g, f = function(a) {
            "function" == typeof e && e(a);
        };
        this.__id__ ? (g = c.callbackId(function() {
    ...
    }, g.prototype.toBase64Data = function() {
        return this.__id__ ? c.execSync(b, "toBase64Data", [ this.__id__ ]) :null;
    }, g.getItems = function() {
        var e, h, i, j, a = [], d = c.execSync(b, "getItems", []);
        for (e = 0; e < d.length; e++) h = d[e].__id__, i = f[h], i || (j = new g(d[e].id, !0), 
        j.__id__ = h, f[h] = j, i = j), a.push(i);
        return a;
    }, g.getBitmapById = function(a) {
        var e, h, d = c.execSync(b, "getBitmapById", [ a ]);
        return d ? (e = f[d.__id__], e || (h = new g(d.id, !0), h.__id__ = d.__id__, f[d.__id__] = h, 
        e = h), e) :null;
    }, h.prototype.drawBitmap = function(a, d, e) {
        c.exec(b, "drawBitmap", [ this.__id__, this.__uuid__, a, d, e ]);
    }, h.prototype.drawText = function(a, d, e) {
        c.exec(b, "drawText", [ this.__id__, this.__uuid__, a, d, e ]);
    }, h.prototype.show = function() {
        c.exec(b, "show", [ this.__id__, this.__uuid__ ]);
    }, h.prototype.hide = function() {
        c.exec(b, "hide", [ this.__id__, this.__uuid__ ]);
    }, h.prototype.clear = function() {
        c.exec(b, "view_clear", [ this.__id__, this.__uuid__ ]), delete e[this.__id__];
    }, h.prototype.animate = function(a, d) {
        var e;
        d && (e = c.callbackId(function() {
            "function" == typeof d && d();
        })), c.exec(b, "view_animate", [ this.__id__, this.__uuid__, a, e ]);
    }, h.prototype.reset = function() {
        c.exec(b, "view_reset", [ this.__id__, this.__uuid__ ]);
    }, h.prototype.restore = function() {
        c.exec(b, "view_restore", [ this.__id__, this.__uuid__ ]);
    }, h.prototype.isVisible = function() {
        return c.execSync(b, "isVisible", [ this.__id__, this.__uuid__ ]);
    }, h.prototype.drawRect = function(a, d) {
        c.exec(b, "view_drawRect", [ this.__id__, this.__uuid__, a, d ]);
    }, h.prototype.interceptTouchEvent = function(a) {
        c.exec(b, "interceptTouchEvent", [ this.__id__, this.__uuid__, a ]);
    }, h.prototype.addEventListener = function(a, d) {
        var e, g, f = this;
        d && (g = function(a) {
            "function" == typeof d && (a.target = f, d(a));
        }, d.callback = g, e = c.callbackId(g)), c.exec(b, "addEventListener", [ this.__id__, this.__uuid__, a, e ]);
    }, h.prototype.setTouchEventRect = function(a) {
        c.exec(b, "setTouchEventRect", [ this.__id__, this.__uuid__, a ]);
    }, h.getViewById = function(d) {
        var g, f = e[d];
        return f || (g = c.execSync(b, "getViewById", [ d ]), g && (f = new a.nativeObj.View(g.id, g.styles, !0), 
        f.__uuid__ = g.uuid, e[f.__id__] = f)), f;
    }, h.startAnimation = function(a, d, e, f) {
        var g, i, j;
        a && d && (i = d instanceof h ? {
            viewId:d.__id__
        } :{
            uuid:d.bitmap ? d.bitmap.__id__ :null,
            texts:{
                value:d.text,
                textStyles:d.textStyles,
                textRect:d.textRect
            }
        }, e && (j = e instanceof h ? {
            viewId:e.__id__
        } :{
            uuid:e.bitmap ? e.bitmap.__id__ :null,
            texts:{
                value:e.text,
                textStyles:e.textStyles,
                textRect:e.textRect
            }
        }), f && (g = c.callbackId(function() {
            "function" == typeof f && f();
        })), c.exec(b, "startAnimation", [ a, i, j, g ]));
    }, h.clearAnimation = function(a) {
        a || (a = "none"), c.exec(b, "clearAnimation", [ a ]);
    }, i = {
        Bitmap:g,
        View:h
    }, a.nativeObj = i;
